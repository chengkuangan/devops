...
if [ "$CREATE_TOOLS" = "true" ]; then
    ...
    echo
    oc new-app -f https://raw.githubusercontent.com/chengkuangan/templates/master/gogs-persistent-template.yaml -p SKIP_TLS_VERIFY=true -p HOSTNAME=$DOMAIN_NAME -n $PROJ_TOOLS_NAME 
